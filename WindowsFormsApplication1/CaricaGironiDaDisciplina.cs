...
namespace WindowsFormsApplication1
{
    public partial class CaricaGironiDaDisciplina : Form
    {
        public CaricaGironiDaDisciplina(bool export)
        {
            ...
            List<Torneo> tornei = !export ? Helper.GetTorneiAttivi() : Helper.GetTorneiNonAttivi();
            ...
            radioButtonMaschile.Checked = (Categoria == "M");
            radioButtonFemminile.Checked = (Categoria == "F");
